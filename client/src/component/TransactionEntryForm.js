                            ...
                            <Col md="auto">
                                ...
                                {['radio'].map((type) => (
                                        <div key={`inline-${type}`} className="mb-0">
                                            <Form.Check inline label="Expense" type={type} id={`inline-${type}-1`} onChange={this.handleBoolChange} name="income" value={false} />
                                            <Form.Check inline label="Income" type={type} id={`inline-${type}-2`} onChange={this.handleBoolChange} name="income" value={true} />
                                        </div>
                                    ))}
                                    </Form.Group>
                                    <Form.Group>
                                ...
                                {["radio"].map((type) => (
                                        <div key={`inline-${type}`} className="mb-0">
                                            <Form.Check inline label="Yes" type={type} id={`inline-${type}-1`} onChange={this.handleBoolChange} name="reoccuring" value={true} />
                                            <Form.Check inline label="No" type={type} id={`inline-${type}-2`} onChange={this.handleBoolChange} name="reoccuring" value={false} />
                                        </div>
                                    ))}
                                    </Form.Group>
                                    <div className="mb-2">
